...
function Navbar({ MIN_AREA, MAX_AREA, resetAll, areaQuantities, areaValues }) {
    ...
    console.log("total area", totalArea, "quantity", areaQuantities, "area values", areaValues)
    ...
    const handlegenrateboq = () => {
        ...
        if (totalArea) {
            navigate('/RegisterUser', {
                state: { totalArea: totalArea, areaValues: areaValues, areaQuantities: areaQuantities }
            })
        }
    }
    // const handlegenrateboq = ()=>{
