...
const Categories = ({
  ...
  const getCategoryFill = (category) => {
    const cleanedCategory = getCleanedCategoryName(category);
    console.log(cleanedCategory);
    return checkIfCategoryCompleted(cleanedCategory) ? "#fff" : "#374A75";
  };
    ...
    Furniture: (
      ...
      >
        <path
          ...
          fill={getCategoryFill("Furniture")}
        />
        <path
    ...
    SmartSolutions: (
      ...
      >
        <path
          ...
          // fill="#374A75"
          fill={getCategoryFill("SmartSolutions")}
        />
        <path
    ...
    CivilPlumbing: (
      ...
      >
        <path
          ...
          // fill="#374A75"
          fill={getCategoryFill("CivilPlumbing")}
        />
        <path
    ...
    PartitionsCeilings: (
      ...
      >
        <path
          ...
          // fill="#374A75"
          //
          fill={getCategoryFill("PartitionsCeilings")}
        />
        <path
        ...
        >
          ...
          {minimizedView &&
            categories.map(({ id, category, subcategories }) => {
              const cleanedCategoryName = getCleanedCategoryName(category);
              console.log(cleanedCategoryName);
