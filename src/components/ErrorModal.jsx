...
//    }
    ...
    return (
        <div className="w-full h-svh z-10 absolute bg-[rgba(220,239,220,0.51)] flex justify-center items-center">
            {/* modal */}
            <div className="grid grid-cols-[2fr_1fr] bg-[#1A3A36] border-2 rounded-3xl w-1/2 mx-auto ">
                ...
                <div className="text-white p-5 flex flex-col justify-center gap-2 m-10">
                   ...
                   <p>pleaase fill in the total area in the swft before making any changes</p>
