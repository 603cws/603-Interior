...
function RecommendComp({ showRecommend, setShowRecommend }) {
  ...
  return (
    <div className="grid grid-cols-[1fr,4fr] h-[95%] w-1/2 ml-auto absolute top-[120px] z-10 right-0">
      {/* first div of grid */}
      <div className="bg-[#D9D9D9] opacity-70 border rounded-l-[60px] h-[75%] overflow-hidden">
        <div className="p-10" onClick={() => setShowRecommend(false)}>
          <MdOutlineCancel size={40} color="gray" className="cursor-pointer opacity-100" />
        </div>
      </div>
