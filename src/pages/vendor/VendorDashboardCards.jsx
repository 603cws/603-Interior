    ...
    <div className="text-[#194F48]">
      <div className="flex gap-4 font-Poppins">
        <div
          ...
          className="bg-gradient-to-r from-[#B4FFF0] to-[#B4FFF0] text-[#194F48]  p-7 rounded-3xl flex flex-col justify-between lg:h-48 lg:w-40 xl:h-56 xl:w-48 relative hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer"
        >
        ...
        <div
          onClick={handleproduct}
          className="bg-gradient-to-r from-[#D8FFD8] to-[#D8FFD8]  p-7 rounded-3xl flex flex-col justify-between lg:h-48 lg:w-40 xl:h-56 xl:w-48 relative hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer"
        >
          <h2 className="self-center text-xl tracking-wide font-medium">
            Addons
          </h2>
        ...
        <div
          onClick={handleproduct}
          className="bg-gradient-to-br from-[#D8F7FF] to-[#D8F7FF]  p-7 rounded-3xl flex flex-col justify-between lg:h-48 lg:w-40 xl:h-56 xl:w-48 relative hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer"
        >
          <h2 className="self-center text-xl tracking-wide font-medium">
            Pending Orders
          </h2>
        ...
        >
          ...
          <img
            src="/images/dashboard-orders.png"
            alt="pending orders"
            className="absolute left-2 bottom-10 h-24 w-24 "
          />
        </div>
      </div>
    </div>
