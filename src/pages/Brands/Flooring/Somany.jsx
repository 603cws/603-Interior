...
const productCollection = [
  "/images/brands/Flooring/somany/collection-product-1.jpg",
  "/images/brands/Flooring/somany/collection-product-2.jpg",
  "/images/brands/Flooring/somany/collection-product-3.jpg",
  "/images/brands/Flooring/somany/collection-product-4.jpg",
  "/images/brands/Flooring/somany/collection-product-5.jpeg",
  "/images/brands/Flooring/somany/collection-product-6.jpg",
  "/images/brands/Flooring/somany/collection-product-7.jpg",
  "/images/brands/Flooring/somany/collection-product-8.jpg",
];
const featured = [
  "/images/brands/Flooring/somany/duragres-slimker.png",
  "/images/brands/Flooring/somany/duragres-plank.png",
  "/images/brands/Flooring/somany/duragres-rocken.png",
  "/images/brands/Flooring/somany/duragres-product.png",
];

const duragresCollection = [
  {
    image: "/images/brands/Flooring/somany/duragres-aspire.png",
  ...
  {
    image: "/images/brands/Flooring/somany/duragres-everstone.png",
...
const tiles = [
  "/images/brands/Flooring/somany/tile-1.jpg",
  "/images/brands/Flooring/somany/tile-2.jpg",
  "/images/brands/Flooring/somany/tile-3.jpg",
  "/images/brands/Flooring/somany/tile-4.jpg",
  "/images/brands/Flooring/somany/tile-5.jpg",
  ...
  return (
    <>
      <section className="h-screen flex flex-col">
        ...
        <div className="flex-1 bg-[url('/images/brands/Flooring/somany/somany-hero.jpg')] m-4 lg:m-2 relative bg-cover bg-center bg-no-repeat"></div>
        <div className="flex items-center justify-around overflow-y-hidden bg-[#D94540] max-h-22 my-5 lg:hidden">
          <img
            src="/images/brands/Flooring/somany/seperator.png"
            alt="seperator"
          />
      ...
      <section className="hidden lg:flex items-center justify-around overflow-y-hidden bg-[#D94540] max-h-22 my-5">
        <img
          src="/images/brands/Flooring/somany/seperator.png"
          alt="seperator"
        />
      ...
      <section className="px-4 max-auto lg:container">
        <div className="grid grid-cols-1 lg:grid-cols-3 justify-between items-stretch gap-3">
          <img
            src="/images/brands/Flooring/somany/product-image-1.png"
            alt="product-image"
            // onClick={() => navigate("productview")}
            // className="cursor-pointer"
          />
          <img
            src="/images/brands/Flooring/somany/product-image-2.png"
            alt="product-image"
            // onClick={() => navigate("productview")}
            // className="cursor-pointer "
          />
          <img
            src="/images/brands/Flooring/somany/product-image-3.png"
            alt="product-image"
            // onClick={() => navigate("productview")}
            // className="cursor-pointer"
          />
      ...
      <section className="px-4 max-auto lg:container my-5">
        <div className="flex flex-col lg:flex-row justify-between items-stretch gap-3">
          <div className="border flex-1 flex justify-center items-center">
            <img
              src="/images/brands/Flooring/somany/duragres-banner.webp"
              alt="product-image"
              className="h-full"
            />
          </div>
          <div className="flex-1 flex flex-col md:flex-row lg:flex-col gap-5">
            {duragresCollection?.map((product, index) => (
              <div key={index} className="flex-1 bg-[#DC3545] flex">
                <div className="bg-[#fff] rounded-[100px] flex-1 flex flex-col lg:flex-row justify-center items-center gap-5 lg:gap-10 p-10">
                  <img
                    src={product.image}
                    alt="product-image"
                    className="max-w-48 lg:max-w-xs w-full max-h-52 lg:max-h-80 border p-2 object-contain"
                  />
                  <div className="">
      ...
      <section className="p-4 lg:container mx-auto">
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/brands/Flooring/somany/browse-collection-bg.jpg')",
          }}
        >
      ...
      <section className="px-4 max-auto lg:container grid grid-cols-2 lg:grid-cols-4 gap-3 py-5 items-stretch">
        {productCollection.map((product, index) => (
          <img
            ...
            key={index}
            // onClick={() => navigate("productview")}
            className="cursor-pointer object-cover lg:h-80 w-full"
          />
        ))}
      </section>

      <section className="px-4 max-auto lg:container lg:flex justify-between items-stretch gap-5">
        <div className="flex-1 border flex justify-center items-center px-12">
          <img
            src="/images/brands/Flooring/somany/duragres-banner-2.webp"
            alt="product-image"
            className="h-full"
          />
        </div>
      ...
      <p className="font-Georgia text-2xl lg:text-4xl text-center text-[#000] lg:max-w-screen-md mx-auto py-10 lg:py-20">
        Somany offers premium surface solutions that combine timeless design,
        trusted craftsmanship, and enduring quality.
      </p>
      <Footer />
    </>
  );
